...
def v_Historial_Academico(request, Matricula):
	...
	A = Alumno.objects.raw("Select * FROM principal_alumno AS A WHERE A.Matricula = '25697'")
	
	return render_to_response("Historial_Academico.html" ,{"Historial":Historial, "Segundo":Segundo, "Tercero":Tercero,"Cuarto":Cuarto,"Quinto":Quinto,"Sexto":Sexto,"Septimo":Septimo,"Octavo":Octavo, "A":A}, context_instance = RequestContext(request))
